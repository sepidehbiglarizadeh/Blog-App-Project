...
function Modal({ open, onClose, title, children, description = "" }) {
  ...
  // create portal chikar mikone? farz konim masalan modale ma gharare dakhele 50 laye div e dakheli baz beshe ba estefade az createPortal migim ke modale ma dakhele document.body baz beshe, 2ta arguman migire avali chiziye ke render mikone dovomi jayie ke migim render bokone
  return (
    open &&
    createPortal(
      <div
